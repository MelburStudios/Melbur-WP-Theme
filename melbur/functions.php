<?php
    ...
    if ( ! isset( $redux_demo ) ) {
        ...
        if ( ! class_exists( 'NM_Custom_Code' ) ) { // Make sure the class isn't defined from an older version of the "Melbur Theme - Content Element" plugin
    ...
    function nm_wpcustomizer_notice() {
        ...
        $theme_name_nospaces = ( $theme_name ) ? preg_replace( '/\s+/', '', $theme_name ) : 'Melbur'; // Remove whitespace from theme name
